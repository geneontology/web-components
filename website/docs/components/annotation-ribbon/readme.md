...
| `subjectBaseUrl`          | `subject-base-url`           | Base URL used when rendering subject label links. When this targets AmiGO, mouse CURIEs are rewritten as `MGI:MGI:<id>` to match AmiGO's bioentity URL convention.                                                                                                       | `string`                      | `"https://amigo.geneontology.org/amigo/gene_product/"`             |
