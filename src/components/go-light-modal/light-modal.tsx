...
export class LightModal {
  ...
  async open() {
    ...
    if (
      ...
      !this.modalCard.classList.contains(this.mclass)
    ) {
    ...
    return (
      <div>
        ...
        <div
          class={classes}
          style={styles}
          ref={(el) => (this.modalCard = el as HTMLDivElement)}
        >
          <div id={this.mid}>
            <h1>
              <span style={{ "text-align": "left" }}>{this.modalTitle}</span>
              <button
            ...
            <div
              id="modal-content"
              ref={(el) => (this.modalContentDiv = el as HTMLDivElement)}
            ></div>
          </div>
        </div>
      </div>
