...
describe("go-annotation-ribbon", () => {
  it("renders the ribbon strips and table containers", async () => {
    ...
    expect(root.shadowRoot?.querySelector("go-annotation-ribbon-strips")).not.toBeNull();
    expect(root.shadowRoot?.querySelector("go-annotation-ribbon-table")).not.toBeNull();
