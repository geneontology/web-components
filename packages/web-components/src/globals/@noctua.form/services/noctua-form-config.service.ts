...
export class NoctuaFormConfigService {
  ...
  constructor() {
    ...
    this.shapePredicates = DataUtils.getPredicates(
      shexJson.goshapes,
      null,
      null,
      false,
  ...
  get activityMoleculeRelationship() {
    const options = [noctuaFormConfig.activityMoleculeRelationship.product];
  ...
  createActivityBaseModel(
    modelType: ActivityType,
    rootNode: ActivityNode,
  ): Activity {
  ...
  createActivityModel(activityType: ActivityType): Activity {
    switch (activityType) {
      case ActivityType.default:
        return ModelDefinition.createActivityShex(
          ModelDefinition.activityUnitDescription,
        );
      case ActivityType.bpOnly:
        return ModelDefinition.createActivityShex(
          ModelDefinition.bpOnlyAnnotationDescription,
        );
      case ActivityType.ccOnly:
        return ModelDefinition.createActivityShex(
          ModelDefinition.ccOnlyAnnotationDescription,
        );
      case ActivityType.molecule:
        return ModelDefinition.createActivityShex(
          ModelDefinition.moleculeDescription,
        );
      case ActivityType.proteinComplex:
        return ModelDefinition.createActivityShex(
          ModelDefinition.proteinComplexDescription,
        );
      case ActivityType.simpleAnnoton:
        return ModelDefinition.createActivityShex(
          ModelDefinition.simpleAnnotonDescription,
        );
    }
  }
  ...
  addActivityNodeShex(
    ...
    return ModelDefinition.addNodeShex(
      activity,
      subjectNode,
      predExpr,
      objectNode,
  ...
  insertActivityNodeShex(
    activity: Activity,
    subjectNode: ActivityNode,
    predExpr: ShapeDescription.PredicateExpression,
    objectId: string = null,
  ): ActivityNode {
    return ModelDefinition.insertNodeShex(
      activity,
      subjectNode,
      predExpr,
      objectId,
  ...
  insertActivityNodeByPredicate(
    activity: Activity,
    subjectNode: ActivityNode,
    bbopPredicateId: string,
    partialObjectNode?: Partial<ActivityNode>,
  ): ActivityNode {
    const predExprs: ShapeDescription.PredicateExpression[] =
      subjectNode.canInsertNodes;
  ...
  findEdge(predicateId) {
    ...
    return edge
      ? Entity.createEntity(edge)
      : Entity.createEntity({ id: predicateId, label: predicateId });
  }
