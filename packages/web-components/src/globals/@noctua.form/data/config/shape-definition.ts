...
export const getShexJson = (
  ...
  subjectIds.forEach((subjectId: string) => {
    const subjectShapes = DataUtils.getSubjectShapes(
      shapes,
      subjectId,
...
export const canInsertEntity = {
  ...
  [ActivityNodeType.GoBiologicalProcess]: [
    ...
    <ShapeDescription>{
      label:
        "Add Has Input (Chemical/Anatomical Entity/Protein Containing Complex)",
      id: ActivityNodeType.GoChemicalEntityHasInput,
      node: <ActivityNodeDisplay>{
        category: [
          EntityDefinition.GoChemicalEntity,
        ...
        type: ActivityNodeType.GoChemicalEntityHasInput,
        label:
          "Has Input (Chemical/Anatomical Entity/Protein Containing Complex)",
        displaySection: noctuaFormConfig.displaySection.fd,
        displayGroup: noctuaFormConfig.displayGroup.bp,
        isExtension: true,
        weight: 14,
    ...
    <ShapeDescription>{
      label:
        "Add Has Output (Chemical/Anatomical Entity/Protein Containing Complex)",
      id: ActivityNodeType.GoChemicalEntityHasInput,
      node: <ActivityNodeDisplay>{
        category: [
          EntityDefinition.GoChemicalEntity,
        ...
        type: ActivityNodeType.GoChemicalEntityHasOutput,
        label:
          "Has Output (Chemical/Anatomical Entity/Protein Containing Complex)",
        displaySection: noctuaFormConfig.displaySection.fd,
        displayGroup: noctuaFormConfig.displayGroup.bp,
        isExtension: true,
        weight: 14,
